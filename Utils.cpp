...
// Declared by sehandle.h at global scope. AOSP has each executable define and
// initialize this in its own main(); it lives here instead so that the ones
// that link libvold without a main() of their own still get a handle.
